...
class ModeloActividad{
	...
	static public function index($tabla, $cantidad, $desde){
		...
		if ($cantidad != null) {
			...
			$stmt = Conexion::conectar()->prepare("SELECT $tabla.ID_ACTIVIDAD, $tabla.ID_USUARIO, $tabla.ID_PERIODO, $tabla.NOMBRE, $tabla.OBJETIVO_GENERAL, $tabla.COMPETENCIA, $tabla.TEMARIO, $tabla.AUTORIZADA, $tabla.ID_ORGANIGRAMA, $tabla.NO_CREDITOS FROM $tabla LIMIT $desde, $cantidad");

		}else{

			$stmt = Conexion::conectar()->prepare("SELECT $$tabla.ID_ACTIVIDAD, $tabla.ID_USUARIO, $tabla.ID_PERIODO, $tabla.NOMBRE, $tabla.OBJETIVO_GENERAL, $tabla.COMPETENCIA, $tabla.TEMARIO, $tabla.AUTORIZADA, $tabla.ID_ORGANIGRAMA, $tabla.NO_CREDITOS FROM $tabla");
	...
	static public function create($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(NOMBRE, OBJETIVO_GENERAL, COMPETENCIA, TEMARIO, AUTORIZADA, ID_ORGANIGRAMA, NO_CREDITOS) VALUES (:NOMBRE, :OBJETIVO_GENERAL, :COMPETENCIA, :TEMARIO, :AUTORIZADA, :ID_ORGANIGRAMA, :NO_CREDITOS)");
